package week3.day12.assignment.testRectangle;
...
public class TestRectangle {
    public static void main(String s[]){
        ...
        String bigColor;
        if(rec1.area() == rec2.area()) System.out.println("넓이는 같습니다.");
        else{
            bigColor = (rec1.area()> rec2.area())? rec1.getColor():rec2.getColor();
            System.out.println("넓이는 "+bigColor+" 직사각형이 더 큽니다.");
        }
        // TODO 2) 두 직사각형의 둘레를 비교하십시오.
        if(rec1.perimeter() == rec2.perimeter()) System.out.println("둘레는 같습니다.");
        else{
            bigColor = (rec1.perimeter()>rec2.perimeter())? rec1.getColor(): rec2.getColor();
            System.out.println("둘레는 "+bigColor+" 직사각형이 더 큽니다.");
        }
    }
}
